# Retail Data Analysis SQL Queries

## Data Cleaning

### 1. Checking for Potential Irrelevant Data
```sql
SELECT *
FROM retail_data rd 
LIMIT 20;
...
### 1. Year-to-Date (YTD) Performance Analysis
```sql
...
### Commented Out: Average Purchase Interval
```sql
